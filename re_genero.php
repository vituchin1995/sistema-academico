                                ...
                                <div class="x_title">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    <h2>Registrar genero<small></small></h2>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="x_content">
                                                    <form class="form-horizontal form-label-left" action="./operaciones/registrar_genero.php" method="POST" id="formulario_docente">


                                                        <div class="item form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Genero
                                                                <span class="required">:</span>
                                                            </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <input id="genero" class="form-control col-md-7 col-xs-12" name="genero" placeholder="Ingrese el semestre correspondiente">
                                                            </div>
                                                        </div>
                                                        <br><br>
