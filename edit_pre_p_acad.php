...
$busc_p_periodo = buscarPre_p_Acad($conexion, $id_p_periodo);
$res_b_p_periodo = mysqli_fetch_array($busc_p_periodo);
$id_periodo_acad = $res_b_p_periodo['id_periodo_acad']
?>
<!DOCTYPE html>
<html lang="en">
				...
				<div class="right_col" role="main">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="x_title">
									...
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="x_panel">
												<div class="x_title">
													<h2>Actualizar presente periodo académico<small></small></h2>
													<div class="clearfix"></div>
												</div>
												<div class="x_content">
													<form class="form-horizontal form-label-left" action="./operaciones/actualizar_pre_p_acad.php" method="POST" id="formulario_docente">
														<input type="text" name="id" value="<?php echo $id_p_periodo; ?>">

														<div class="item form-group">
															<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Periodo académico
                          ...
                          <?php if($id_periodo_acad === $id_p_periodo){
                            echo "selected";
                          } ?>
                          ><?php echo $res_b_p_periodo_acad['nombre']; ?></option>
                          <?php
                          };
                          ?>
                        </select>
